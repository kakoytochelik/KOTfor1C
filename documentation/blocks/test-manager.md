...
- Дерево групп и тестов:
  ...
  - для главных сценариев: открытие `test.yaml`, переименование и удаление;
...
- Для главных сценариев: открытие `test.yaml`, переименование и удаление через контекстное меню.
