...
- Менеджер баз используется как общий слой выбора ИБ для `KOT Form Explorer` и встроенной подготовки ИБ перед запуском Vanessa Automation.
