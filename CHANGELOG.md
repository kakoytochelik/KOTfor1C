...
- Добавлен исследователь форм 1С `KOT Form Explorer`:
...
- Весь интерфейс плагина был обновлен визуально;
- Убраны лишние интерфейсные элементы.

## Исправления и доработки

- Наличие служебных баз для запуска Сборки сценариев или Vanessa Automation более не требуется, расширение само создает базу в фоновом режиме.
