...
### Управление кодом и именем вложенного сценария
...
- Обе команды доступны как через контекстное меню в `KOT - Редактирование`, так и из самого редактора по иконке карандаша напротив соответствующих полей.
